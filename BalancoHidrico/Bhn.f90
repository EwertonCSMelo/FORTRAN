...
3      INTRO=NINT*IS                                                    BH 00300
     ...
     *        SDIF,TNEG,HEMI(2),FF,SPREC,SIO,p
...
c5554  FORMAT(12(F5.1,1X))
      DO I=1,12
      READ(5,*,IOSTAT=SIO)PREC(I), TEMP(I)                                      
      END DO                                                  
      DIR1=2                                                            BH 00650
       LATS=0                                                           BH 00660
       LONGS=0                                                          BH 00670
...
1014   FORMAT(//,28X,'BALANCO HIDRICO SEGUNDO THORNTHWAITE(1957)')      
1015   FORMAT(/,28X,'LOCAL - ',20A1,2X,'LAT ',I2,'G',I2,'M',2X,A1,3X,'LO
     *NG ',I3,'G',I2,'M',1X,A1,5X,'ALT ',F6.1,1X,'M')                   
1016  FORMAT(28X,78('-'))                                              
1017  FORMAT(28X,'MES   T(C)  IMC   E   CORR    EP    P     DIF  NACM  
     *RMZ  ALT    ER  DEF  EXC')                                        
1018   FORMAT(28X,A3,F6.1,F6.1,F5.1,F6.1,I6,F7.1,3I6,I5,F6.0,2I5)       
1019   FORMAT(28X,'ANO',6X,I6,11X,I6,I7,6X,12X,I5,I6,2I5)                       
1020   FORMAT(28X,'IA=',I4,5X,'IU=',I4,5X,'IH=',I4,32X,'CAP.ARM.=',I3,1X
     *,'MM')                                                            
1021  FORMAT(28X,'ERRO... ESTE PROGRAMA NAO RECONHECE A CA = ',I3)      
63    STOP                                                              
      END                                                               
